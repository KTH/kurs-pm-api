...
const { MigrateMemo, System } = require("./controllers");

// System pages routes
const systemRoute = AppRouter();
systemRoute.get(
  "system.migrate",
  config.proxyPrefixPath.uri + "/_migrate",
  MigrateMemo.migrate
);
...
apiRoute.register(
  paths.api.deleteCourseMemoDataById,
  CourseMemo.deleteMemoDataById
);

apiRoute.register(paths.api.postCourseMemoData, CourseMemo.postMemoData);
apiRoute.register(
  paths.api.getCourseMemoListByCourseCode,
  CourseMemo.getCourseMemoList
);
